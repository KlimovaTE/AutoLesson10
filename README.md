# План внедрения автоматизации тестирования возможности записаться на обучение профессии «Тестировщик ПО» 
...
- ожидаемый результат: форма отправлена. На экране появилась надпись "Запись произвенена. Наш консультант свяжется с Вами в ближайшее время"
...
1. Нажать кнопку "Записаться"
- ожидаемый результат: форма не отправлена. Поля подсвечивается красным. Под полами появилась надписи "Обязательное поле"
...
1. В поле "Имя" ввести строку, состоящую из одной букв кириллицы или латиницы (например "а")
1. В поле для ввода телефона ввести строку, состоящую от 9 до 14 цифр. Строка может содержать символы "+", "(", ")", "-" (например 55555555555)
1. Нажать кнопку "Записаться"
...
1. В поле "Имя" ввести строку, содержащую цифры (например "ааа№")
1. В поле для ввода телефона ввести строку, состоящую от 9 до 14 цифр. Строка может содержать символы "+", "(", ")", "-" (например 55555555555)
1. Нажать кнопку "Записаться"
- ожидаемый результат: форма не отправлена. Поле "Имя" подсвечивается красным. Под полем появилась надпись "Должно состоять из букв"
...
1. В поле "Имя" ввести строку, состоящее из букв кириллицы или латиницы, где длина строки > 1 буквы. Строка может содержать дефис (например "Иван")
1. В поле для ввода телефона ввести строку, состоящую меньше, чем из 9 цифр. Строка может содержать символы "+", "(", ")", "-" (например +55555555)
1. Нажать кнопку "Записаться"
...
1. В поле "Имя" ввести строку, состоящее из букв кириллицы или латиницы, где длина строки > 1 буквы. Строка может содержать дефис (например "Иван")
1. В поле для ввода телефона ввести строку, состоящую больше, чем из 14 цифр. Строка может содержать символы "+", "(", ")", "-" (например +555111222333444)
1. Нажать кнопку "Записаться"
- ожидаемый результат: форма не отправлена. Поле для ввода телефона подсвечивается красным. Под полем появилась надпись "Номер в формате +9 (999) 999-99-99"
